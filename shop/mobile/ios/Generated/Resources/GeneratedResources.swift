...
internal enum Resources {
  internal enum Assets {
    ...
    internal static let contactAddress = ImageAsset(name: "contact_address")
    internal static let contactComment = ImageAsset(name: "contact_comment")
    internal static let contactEmail = ImageAsset(name: "contact_email")
  ...
  internal enum Colors {
    ...
    internal static let stateCanceled = ColorAsset(name: "stateCanceled")
    internal static let stateCompleted = ColorAsset(name: "stateCompleted")
    internal static let stateNew = ColorAsset(name: "stateNew")
    internal static let statePending = ColorAsset(name: "statePending")
